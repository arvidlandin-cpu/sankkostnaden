  ...
  return (
    <>
      <Head>
        ...
        <link rel='canonical' href='https://sankkostnaden.se/elavtal/vilket-elavtal-passar-mig/' /><script type='application/ld+json' dangerouslySetInnerHTML={{__html: JSON.stringify({'@context':'https://schema.org','@type':'WebPage',name:"Fast, rörligt eller kvartspris 2026? Testa vilket elavtal som passar",description:"Fast, rörligt eller kvartspris? Svara på fem frågor om förutsägbarhet, elanvändning och styrning och se vilken avtalsform som passar din profil.",url:"https://sankkostnaden.se/elavtal/vilket-elavtal-passar-mig/",isPartOf:{'@type':'WebSite',name:'Sänk Kostnaden',url:'https://sankkostnaden.se/'}})}} />
        <meta name='robots' content='index,follow' />
      </Head>
      <SmartSelector eyebrow='SMARTVAL · ELAVTAL' title='Fast, rörligt eller kvartspris – vad passar dig?' intro='Vi försöker inte gissa nästa elpris. I stället väger testet det som faktiskt skiljer avtalsformerna åt för dig: behovet av förutsägbarhet, styrbar förbrukning och hur aktiv du vill vara.' questions={questions} results={results} disclaimer='Resultatet är generell beslutshjälp, inte en prognos. Konsumenternas Energimarknadsbyrå betonar att kvartspris främst kan gynna den som faktiskt kan flytta elanvändning till billigare perioder.' backHref='/elavtal/' backLabel='Elavtal' partnerCategory='el' partnerIntent='electricity' />
    </>
  );
}
