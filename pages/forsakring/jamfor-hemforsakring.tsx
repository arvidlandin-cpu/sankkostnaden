...
export default function Page(){
 return <IntentGuide
  ...
  sections={[
   ...
   {heading:'Hyresrätt eller bostadsrätt?',body:'Boendeformen påverkar vad du behöver kontrollera. I bostadsrätt behöver du även se hur bostadsrättsskyddet är ordnat, medan en hyresrätt har andra förutsättningar. Jämför därför rätt typ av hemförsäkring.'},{heading:'Räkna samlingsrabatter på hela paketet',body:'En rabatt på hemförsäkringen behöver inte ge lägst total kostnad om andra försäkringar samtidigt blir dyrare. Jämför nettot för hela försäkringspaketet om du samlar flera försäkringar hos samma bolag.'}
  ]}
  related={[
