...
export default function Page() {
  return (
    <IntentGuide
      ...
      related={[{ href: '/bredband/bredband-pa-min-adress/', label: 'Bredband på min adress' }, { href: '/bredband/hur-snabbt-bredband-behover-du/', label: 'Hur snabbt bredband behöver du?' }, { href: '/bredband/billigaste-bredbandet/', label: 'Billigaste bredbandet 2026' }]}
    />
  );
}
