...
export default function Page() {
  return (
    <IntentGuide
      ...
      sections={[{ heading: 'Vad är fiberbredband?', body: 'Fiber skickar data som ljussignaler i fiberkabel och kan ge hög kapacitet i både ned- och uppladdning. Vilka operatörer och hastigheter du kan välja beror på vilket fibernät fastigheten är ansluten till.' }, { heading: 'Vad kostar bredband via fiber?', body: 'Månadspriset beror på adress, nät, operatör och hastighet. Jämför därför samma hastighetsnivå på din egen adress och räkna in kampanj, ordinarie pris, router och eventuella startavgifter.' }, { heading: 'Adressen bestämmer utbudet', body: 'Fiberutbudet kan skilja mellan olika nät och fastigheter. Börja därför med vad som faktiskt går att beställa innan du jämför priser och hastigheter.' }, { heading: '100 Mbit/s kan räcka längre än många tror', body: 'Vanlig streaming, surf och videosamtal kräver ofta mindre kapacitet än de högsta abonnemangen erbjuder. Ett lägre hastighetssteg kan därför ge en återkommande besparing utan märkbar försämring.' }, { heading: 'Jämför ordinarie pris efter kampanjen', body: 'Räkna hela första året och gärna även kostnaden därefter. Lägg till eventuella startavgifter och routerkostnader för att få en rättvis jämförelse.' }, { heading: 'Wifi och fiber är inte samma sak', body: 'Om hastigheten är dålig i vissa rum kan problemet ligga i hemnätet snarare än fiberabonnemanget. Testa nära routern eller med kabel innan du uppgraderar hastigheten.' }]}
