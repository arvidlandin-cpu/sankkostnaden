  ...
  return (
    <>
      ...
      <header className='topbar'>
        ...
        {hasPartnerOutput?<a className='topbarCta' href='#guide-partners'>Jämför här →</a>:<Link className='topbarCta' href={categoryPath}>Till översikten →</Link>}
      </header>
      <main>
        ...
        <article className='article guideWrap'>
          ...
          {!elevatePartnerBlock && <div id='guide-partners'>{(intent === 'compare' || (category === 'forsakring' && (intent === 'home' || intent === 'pet')) || (category === 'ekonomi' && intent === 'loan')) ? <PartnerDirectory category={category} intent={intent} heading={compareHeadings[category]} /> : <PartnerOffers category={category} intent={intent} heading={offerHeading} />}</div>}
