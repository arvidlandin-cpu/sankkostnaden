    ...
    <>
      ...
      <main>
        ...
        <article className='article guideWrap'>
          ...
          <div id='guide-partners'>{(intent === 'compare' || (category === 'forsakring' && (intent === 'home' || intent === 'pet')) || (category === 'ekonomi' && intent === 'loan')) ? <PartnerDirectory category={category} intent={intent} heading={compareHeadings[category]} /> : <PartnerOffers category={category} intent={intent} heading={offerHeading} />}</div>
