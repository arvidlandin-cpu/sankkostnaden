...
const config = {
  ...
  mobil:{title:'Hur vill du hitta rätt mobilabonnemang?',intro:'Gå direkt till Telia eller Vimla, eller ringa in surf och behov först.',direct:'Jämför mobilabonnemang',help:'Hjälp mig välja surf',helpHref:'/mobil/hur-mycket-surf-behover-jag/',read:'Jämför billiga abonnemang',readHref:'/mobil/billigaste-mobilabonnemanget/'},
