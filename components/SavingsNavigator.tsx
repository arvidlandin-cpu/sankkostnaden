...
const questions:Record<PartnerCategory,{q:string;opts:Choice[]}>={
 ...
 ekonomi:{q:'Vad vill du göra?',opts:[{label:'Jämföra privatlån',href:'/ekonomi/jamfor-privatlan/',intent:'loan'},{label:'Se om samlingslån kan löna sig',href:'/ekonomi/samlingslan/',intent:'loan'},{label:'Få bättre koll på ekonomin',href:'/ekonomi/',intent:'saving'}]}
};
...
export default function SavingsNavigator(){
 ...
 return <section className='savingsNav'>
  <div className='savingsNavTop'><div><span>SNABBSTART</span><h2>Sänk en kostnad nu.</h2><p>Välj kostnaden du vill sänka. Efter två snabba val får du en tydlig väg vidare – utan formulär eller inloggning.</p></div><div className='stepDots'><b className='on'>1</b><i/><b className={area?'on':''}>2</b><i/><b className={choice?'on':''}>3</b></div></div>
