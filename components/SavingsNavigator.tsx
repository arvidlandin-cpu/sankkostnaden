...
const questions:Record<PartnerCategory,{q:string;opts:Choice[]}>={
 ...
 ekonomi:{q:'Vad vill du jämföra?',opts:[{label:'Privatlån',href:'/ekonomi/#jamfor-lan',intent:'loan'},{label:'Samlingslån',href:'/ekonomi/#samlingslan',intent:'loan'},{label:'Privatekonomi',href:'/ekonomi/',intent:'saving'}]}
};
