...
export const partners: Partner[] = [
  ...
  { name:'Hallon', domain:'hallon.se', category:'mobil', note:'Mobilabonnemang med olika surfmängder. Kontrollera aktuellt pris, surfmängd och villkor hos operatören.', trackingUrl:'https://go.hallon.se/t/t?a=1083250335&as=2111115937&t=2&tk=1', status:'active', intents:['compare','data','no-binding'], priority:10, cta:'Se abonnemang hos Hallon' },
  { name:'Vimla', domain:'vimla.se', category:'mobil', note:'Mobilabonnemang med olika surfmängder. Kontrollera aktuellt pris och villkor hos operatören.', trackingUrl:'https://on.vimla.se/t/t?a=1081333617&as=2111115937&t=2&tk=1', status:'active', intents:['compare','family','data','no-binding'], priority:8 },
  ...
  { name:'Comviq', domain:'comviq.se', category:'mobil', note:'Mobilabonnemang med olika surfmängder och familjealternativ. Kontrollera aktuellt pris, surfmängd och villkor hos Comviq.', trackingUrl:'https://at.to.comviq.se/t/t?a=1864643893&as=2111115937&t=2&tk=1', status:'active', intents:['compare','family','data','no-binding'], priority:9, cta:'Se abonnemang hos Comviq' },
  ...
  { name:'Gofido', domain:'gofido.se', category:'forsakring', note:'Digital hemförsäkring. Jämför premie, självrisk, omfattning och villkor innan du tecknar.', trackingUrl:null, status:'closed', intents:['home','compare'], priority:9, cta:'Se pris & villkor' },
