...
export const partners: Partner[] = [
  ...
  { name:'Tre', domain:'tre.se', category:'mobil', note:'Mobilabonnemang och mobilt bredband. Kontrollera aktuellt pris, surfmängd, nät, bindningstid och villkor hos Tre.', trackingUrl:'https://at.tre.se/t/t?a=1243479444&as=2111115937&t=2&tk=1', status:'active', linkCheckedAt:'2026-09-24', intents:['compare','family','data','mobile-broadband'], priority:9, monetizationWeight:1.3, cta:'Se abonnemang hos Tre' },
  { name:'Comviq', domain:'comviq.se', category:'mobil', note:'Mobilabonnemang med olika surfmängder och familjealternativ. Kontrollera aktuellt pris, surfmängd och villkor hos Comviq.', trackingUrl:'https://at.to.comviq.se/t/t?a=1864643893&as=2111115937&t=2&tk=1', status:'active', linkCheckedAt:'2026-09-24', intents:['compare','family','data','no-binding'], priority:9, monetizationWeight:1.2, cta:'Se abonnemang hos Comviq' },
  { name:'Tele2', domain:'tele2.se', category:'mobil', note:'Mobilabonnemang med olika surfmängder och familjealternativ. Kontrollera aktuellt pris, surfmängd, nät och villkor hos Tele2.', trackingUrl:'https://at.to.tele2.se/t/t?a=1864648074&as=2111115937&t=2&tk=1', status:'active', linkCheckedAt:'2026-09-24', intents:['compare','family','data'], priority:9, monetizationWeight:1.1, cta:'Se abonnemang hos Tele2' },
