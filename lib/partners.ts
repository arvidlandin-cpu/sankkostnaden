...
export type PartnerIntent = 'compare' | 'family' | 'data' | 'no-binding' | 'fiber' | 'mobile-broadband' | 'pet' | 'home' | 'travel' | 'health' | 'claims' | 'income-protection' | 'electricity' | 'refurbished' | 'loan' | 'saving';
...
export type Partner = {
  ...
  commissionPrograms?: Record<string, number>;
};
...
export const partners: Partner[] = [
  ...
  { name:'E.ON', domain:'eon.se', category:'el', note:'Elavtal för privatkunder. Kontrollera aktuellt pris, avtalsform, påslag, fasta avgifter och villkor hos E.ON.', trackingUrl:'https://go.adt256.com/t/t?a=2028688348&as=2111115937&t=2&tk=1', status:'active', linkCheckedAt:'2026-09-26', intents:['compare','electricity'], priority:9, monetizationWeight:9, commissionPrograms:{'Elavtal villa':900}, cta:'Se elavtal hos E.ON' },
  { name:'Dalakraft', domain:'dalakraft.se', category:'el', note:'Elavtal för privatkunder. Kontrollera aktuellt pris, avtalsform, påslag, fasta avgifter och villkor hos Dalakraft.', trackingUrl:'https://dot.dalakraft.se/t/t?a=1970530769&as=2111115937&t=2&tk=1', status:'active', linkCheckedAt:'2026-09-26', intents:['compare','electricity'], priority:9, monetizationWeight:7, commissionPrograms:{'Order':700}, cta:'Se elavtal hos Dalakraft' },
  { name:'Bixia', domain:'bixia.se', category:'el', note:'Elavtal för privatkunder. Kontrollera aktuellt pris, avtalsform, påslag, fasta avgifter och villkor hos Bixia.', trackingUrl:'https://to.bixia.se/t/t?a=1934384583&as=2111115937&t=2&tk=1', status:'active', linkCheckedAt:'2026-09-26', intents:['compare','electricity'], priority:9, monetizationWeight:7, commissionPrograms:{'Order':700}, cta:'Se elavtal hos Bixia' },
  { name:'Telinet Energi', domain:'telinet.se', category:'el', note:'Elavtal för privatkunder. Kontrollera aktuellt pris, avtalsform, påslag, fasta avgifter och villkor hos Telinet Energi.', trackingUrl:'https://at.telinet.se/t/t?a=1870484942&as=2111115937&t=2&tk=1', status:'active', linkCheckedAt:'2026-09-26', intents:['compare','electricity'], priority:9, monetizationWeight:8, commissionPrograms:{'Rörligt elavtal':800}, cta:'Se elavtal hos Telinet Energi' },
  ...
  { name:'Chilimobil', domain:'chilimobil.se', category:'mobil', note:'Mobilabonnemang med olika surfalternativ. Kontrollera aktuellt pris, surfmängd, nät och villkor hos Chilimobil.', trackingUrl:'https://go.chilimobil.se/t/t?a=1519654615&as=2111115937&t=2&tk=1', status:'active', linkCheckedAt:'2026-09-26', intents:['compare','data','no-binding'], priority:9, monetizationWeight:2, cta:'Se abonnemang hos Chilimobil' },
  { name:'Fello', domain:'fello.se', category:'mobil', note:'Mobilabonnemang för privatkunder. Kontrollera aktuellt pris, surfmängd, nät och villkor hos Fello.', trackingUrl:'https://go.adt246.net/t/t?a=1074737227&as=2111115937&t=2&tk=1', status:'active', linkCheckedAt:'2026-09-26', intents:['compare','data'], priority:9, monetizationWeight:3, commissionPrograms:{'Abonnemang':287}, cta:'Se abonnemang hos Fello' },
  { name:'Nestor Mobil', domain:'nestormobil.se', category:'mobil', note:'Mobilabonnemang. Kontrollera aktuellt pris, surfmängd, nät och villkor hos Nestor Mobil.', trackingUrl:'https://go.adt242.com/t/t?a=1945386816&as=2111115937&t=2&tk=1', status:'active', linkCheckedAt:'2026-09-25', intents:['compare','data'], priority:9, commissionPrograms:{'Order':300}, cta:'Se abonnemang hos Nestor Mobil' },
  ...
  { name:'Compricer', domain:'compricer.se', category:'forsakring', note:'Jämförelsetjänst för försäkringar. Jämför premie, självrisk, omfattning och villkor och kontrollera aktuella erbjudanden innan du väljer.', trackingUrl:'https://at.compricer.se/t/t?a=1052530634&as=2111115937&t=2&tk=1&url=https%3A%2F%2Fwww.compricer.se%2Fforsakring%2Fhem%2F', status:'active', linkCheckedAt:'2026-09-24', intents:['home','compare'], priority:10, commissionPrograms:{'Villaförsäkring sök':16}, cta:'Jämför försäkringar hos Compricer' },
  { name:'Hedvig', domain:'hedvig.com', category:'forsakring', note:'Digital försäkring för privatpersoner. Kontrollera aktuell premie, självrisk, omfattning och villkor innan du tecknar.', trackingUrl:'https://addrevenue.io/t?a=985083&c=3469603', status:'active', linkCheckedAt:'2026-09-24', intents:['home','pet','compare','income-protection'], priority:9, commissionPrograms:{'Trygghet':500,'Fritidshus':500,'Katt':360,'Hund':620,'Bil':840,'Olycksfall':180,'Hus & Villa':820,'Lägenhet':240,'Lägenhet - student':300}, cta:'Se pris & villkor hos Hedvig' },
