...
export const partners: Partner[] = [
  ...
  { name:'Elskling', category:'el', note:'Jämförelsetjänst för elavtal. Jämför aktuella elavtal och kontrollera pris, påslag, avgifter och villkor innan du väljer.', trackingUrl:'https://go.adt231.net/t/t?a=2066001225&as=2111115937&t=2&tk=1', status:'active', intents:['compare','electricity'], priority:10, cta:'Jämför elavtal' },
  { name:'Vattenfall', category:'el', note:'Elavtal för privatkunder. Kontrollera aktuellt pris, avtalsform, påslag, fasta avgifter och övriga villkor hos Vattenfall.', trackingUrl:'https://go.adt291.com/t/t?a=1515676052&as=2111115937&t=2&tk=1', status:'active', intents:['compare','electricity'], priority:9, cta:'Se elavtal hos Vattenfall' },
  { name:'Mölndal Energi', category:'el', note:'Elavtal för privatkunder. Kontrollera aktuellt pris, avtalsform, påslag, fasta avgifter och övriga villkor hos Mölndal Energi.', trackingUrl:'https://clk.tradedoubler.com/click?p=354814&a=3498422', status:'active', intents:['compare','electricity'], priority:9, cta:'Se elavtal hos Mölndal Energi' },
  ...
  { name:'Ownit', category:'bredband', note:'Bredband via fiber. Kontrollera tillgänglighet på adressen, aktuell hastighet, pris, utrustning och villkor hos Ownit.', trackingUrl:'https://go.adt242.com/t/t?a=1211102606&as=2111115937&t=2&tk=1', status:'active', intents:['compare','fiber'], priority:9, cta:'Se bredband hos Ownit' },
  ...
  { name:'Hallon', category:'mobil', note:'Mobilabonnemang med olika surfmängder. Kontrollera aktuellt pris, surfmängd och villkor hos operatören.', trackingUrl:'https://go.hallon.se/t/t?a=1083250335&as=2111115937&t=2&tk=1', status:'active', intents:['compare','data','no-binding'], priority:10, cta:'Se abonnemang hos Hallon' },
  ...
  { name:'Tre', category:'mobil', note:'Mobilabonnemang och mobilt bredband. Kontrollera aktuellt pris, surfmängd, nät, bindningstid och villkor hos Tre.', trackingUrl:'https://at.tre.se/t/t?a=1243479444&as=2111115937&t=2&tk=1', status:'active', intents:['compare','family','data','mobile-broadband'], priority:9, cta:'Se abonnemang hos Tre' },
  { name:'Comviq', category:'mobil', note:'Mobilabonnemang med olika surfmängder och familjealternativ. Kontrollera aktuellt pris, surfmängd och villkor hos Comviq.', trackingUrl:'https://at.to.comviq.se/t/t?a=1864643893&as=2111115937&t=2&tk=1', status:'active', intents:['compare','family','data','no-binding'], priority:9, cta:'Se abonnemang hos Comviq' },
  { name:'Tele2', category:'mobil', note:'Mobilabonnemang med olika surfmängder och familjealternativ. Kontrollera aktuellt pris, surfmängd, nät och villkor hos Tele2.', trackingUrl:'https://at.to.tele2.se/t/t?a=1864648074&as=2111115937&t=2&tk=1', status:'active', intents:['compare','family','data'], priority:9, cta:'Se abonnemang hos Tele2' },
