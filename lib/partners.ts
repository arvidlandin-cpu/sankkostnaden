...
export const partners: Partner[] = [
  ...
  { name:'ERGO Försäkring', domain:'erv.se', category:'forsakring', note:'Partnerlänken leder till Europeiska ERV:s flöde för reseförsäkring. Kontrollera omfattning, självrisk, reslängd, undantag och villkor innan du tecknar.', trackingUrl:'https://on.erv.se/t/t?a=297967547&as=2111115937&t=2&tk=1', status:'active', intents:['travel'], priority:8, monetizationWeight:0.5, cta:'Se reseförsäkring hos Europeiska ERV' },
